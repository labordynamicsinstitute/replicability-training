...
3. In the pop-up, you should have all the necessary information
   ...
   - `Bitbucket URL` has the information to clone the repository
...
4. Clone the Bitbucket repository associated with the issue 
...
5. Open the Manuscript Central link 
   1. Use LastPass to access Manuscript Central
